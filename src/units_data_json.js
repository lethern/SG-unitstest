const gUnits = {
	"Argent": {
		...
		attacks: [{
			...
			damage: 10,
			speed: 1.5,
			bonus: [{ bonus: 'Heavy', bonus_damage: 3 }],
			range: 6,
			projectile_speed: 12
		}],
		abilities: [{
			name: 'High Energy',
			energy: 10,
			desc: "Imbues this unit's weapon, allowing it to deal 50% increased damage. Right-click to enable/disable autocasting.",
		}],
		traits: [{
			...
			desc: "Increases the range of this unit's charged weapon by +3. Also increases High Energy's bonus from 50% to 75%",
		}, {
	...
	"Gaunt": {
		...
		attacks: [{
			...
			damage: 8,
			speed: 1.3,
			bonus: [{ bonus: 'Light', bonus_damage: 2 }],
			range: 6,
		}, {
			name: 'Bone Axes',
			target: ['Ground'],
		...
		traits: [{
			...
			desc: "35% increased movement speed.",
		}],
	},
	"Atlas": {
		name: 'Atlas',
	...
	"SCOUT": {
		...
		attacks: [{
			...
			damage: 5,
			speed: 1.4,
			bonus: [{ bonus: 'Light', bonus_damage: 3 }, { bonus: 'Creep', bonus_damage: 5 }],
			range: 0.1
		}],
		abilities: [{
			name: "On The Hunt",
	...
	"MedTech": {
		...
		abilities: [{
			...
			desc: "Unleashes a swarm of nanobots onto a target unit. If the target is friendly, nearby mechanical units are healed for 20 health per second over 20 seconds. If the target is an enemy, nearby enemy mechanical units are damaged for 15 health per second. Right-click to enable autocasting. Automatically casts on damaged friendly mechanical units.",
		}, {
			name: "System Shock",
			energy: 50,
	...
	"Magmadon": {
		...
		attacks: [{
			...
			target: ["Ground"],
			damage: 30,
			bonus: [{ bonus: "Heavy", bonus_damage: 20 }],
			speed: 1.8,
			range: 0.5,
		}],
		abilities: [{
	...
	"Hellborne": {
		...
		attacks: [{
			...
			damage: 25,
			speed: 3,
			bonus: [{ bonus: "Structure", bonus_damage: 75 }],
			range: 14,
		}],
		traits: [{
			name: "Shatter",
	...
	"Hexen": {
		...
		abilities: [{
			...
			desc: "Covers a target area in bubbling ash and tar. Enemy ground units in the area will be Infested and take 700% bonus damage from Infest.",
		}, {
			name: "Shroudweave",
			cooldown: 120,
	...
	"Weaver": {
		...
		traits: [{
			...
			name: "Shroudwalk",
			desc: "This unit has 50% bonus movement speed in Shroud.",
		}],
	},
	"Imp": {
		name: "Imp",
	...
	"Kri": {
		...
		traits: [{
			...
			desc: "Improves Blaze of Light, increasing damage done by +40 and allowing Kri to move when they take fatal damage before they explode.",
		}],
	},
	"Scanner": {
		name: "Scanner",
	...
	"Seraphim": {
		...
		abilities: [{
			name: "Condemnation",
			energy: 5,
			desc: "Increases the damage of this unit's attack against Creeps by 300%. Right-click to enable/disable autocasting.",
		}, {
			name: "Resolute Seal",
			energy: 25,
			casting_time: 0.5,
			...
			cooldown: 15,
			duration: 2,
			desc: "Increases this unit's movement speed by 100% and allows it to evade 50% of incoming attacks for 2 seconds. Right-click to enable/disable autocasting.",
		}],
		traits: [{
			name: "Creepbane Guard",
			desc: "This unit takes 75% damage reduction from Creeps.",
		}],
	},
	"Animancer": {
		name: "Animancer",
		...
		abilities: [{
			...
			cooldown: 8,
			duration: 10,
			desc: "Drains 20 health and 20 energy per second from a target enemy unit over 10 seconds. 50% of the drained vitals are redistributed to friendly units near the Animancer. Right-click to enebale autocasting.",
		}, {
			name: "Unseen Veil",
			energy: 50,
			cooldown: 60,
			...
			desc: "Triggers a singularity at a target location, slowing down all units in the area by 15%. Deals 20/25/30/35, 50 damage per second to units in the area for 4 seconds and then 40 damage per second for an additional 4 seconds. Does not damage structures.",
		}],
	},
	"Archangel": {
		name: "Archangel",
	...
	"Saber": {
		...
		attacks: [{
			...
			damage: 40,
			speed: 2.5,
			bonus: [{ bonus: "Heavy", bonus_damage: 50 }],
			range: 11,
		}],
		abilities: [{
	...
	"Vector": {
		...
		abilities: [{
			...
			name: "Recall",
			req: ["Research Recall"],
			desc: "Returns the Vector to its previous location.",
		}],
		traits: [{
